...
import type { AboutPage as AboutPageData, SiteSetting } from '@/payload-types'
import styles from './page.module.css'

export interface AboutViewProps {
  page: AboutPageData | null | undefined
  settings: SiteSetting | null | undefined
}

/**
 * Pure presentational render of the About page. Rendered either straight from the server (public
 * visitors) or from `AboutLive` inside the Live Preview iframe (editors).
 */
export const AboutView = ({ page, settings }: AboutViewProps) => {
